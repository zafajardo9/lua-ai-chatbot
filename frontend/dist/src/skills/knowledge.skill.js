...
const knowledgeSkill = new LuaSkill({
    ...
    description: "Ingest documents and answer questions from the knowledge base. Use this skill to store information from uploaded files and retrieve answers based on that knowledge.",
    context: `
